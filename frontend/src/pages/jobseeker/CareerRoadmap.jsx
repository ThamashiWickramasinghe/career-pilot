            ...
            >
              ...
              {currentStep === 'welcome' && (
                <div className="h-full flex flex-col justify-between relative">
                  ...
                  <button
                    onClick={startManual}
                    className="relative z-10 w-full py-3.5 rounded-lg font-bold text-white text-sm flex items-center justify-center gap-2 transition hover:bg-[#765C7A]"
                    style={{
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="w-11 h-11 rounded-lg flex items-center justify-center text-white disabled:opacity-50 transition hover:bg-[#765C7A]"
                        style={{
                          background: theme.primary,
                        }}
                      >
